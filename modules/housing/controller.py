...
from models.housing_out import HousingWithFacultyDTO, HousingBaseWithFacultyDto
...
@housing_router.get('/', response_model=list[HousingWithFacultyDTO], status_code=200,
...
@housing_router.get('/{id}', response_model=HousingWithFacultyDTO, status_code=200, name='Получение корпуса')
